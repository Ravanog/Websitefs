...
DB_URI = environ.get("DB_URI", "mongodb+srv://anikush8310_db_user:mIE1xcFcYComgN04@cluster0.32kt1j6.mongodb.net/?appName=Cluster0")
...
WEBSITE_URL = environ.get("WEBSITE_URL", "https://streampage-liard.vercel.app/") # For More Information Check Video On Yt - @Tech_VJ
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "overall-genovera-koyebuser123-9b970415.koyeb.app")
